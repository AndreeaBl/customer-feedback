...
public class TestComputingDomainServices {
	private static Logger logger = Logger.getLogger(TestComputingDomainServices.class.getName());
	...
	// Test Business Logic
//	@Test
	public void test1_SummaringProjectDomainService() {
